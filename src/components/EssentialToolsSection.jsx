        ...
        >
          ...
          >
            <div className="flex flex-row-reverse justify-between items-center">
              ...
              <h3 className="text-2xl text-left font-bold text-gray-900 mb-3">
                Co-sell network
              </h3>
            </div>
          ...
          <motion.div
            variants={item}
            className="lg:col-span-2 bg-linear-to-r from-[#4D5D69] to-[#A16A6B] rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl text-white overflow-hidden relative"
          >
            <div className="flex items-center justify-between">
              <div className="w-full">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-4 flex items-center gap-3 sm:gap-4">
                    <span className="text-4xl sm:text-5xl bg-linear-to-r from-[#FFD900] via-[#FBFD89] to-[#FFD900] text-transparent bg-clip-text">
                      Enterprise
                    </span>
                    <span className="bg-linear-to-r from-[#FFD900] via-[#FBFD89] to-[#FFD900] text-transparent bg-clip-text text-lg sm:text-xl">
                      plan
                    </span>
                  </h3>
                ...
                <p className="text-white/90 leading-relaxed text-left max-w-full sm:max-w-[70%]">
                ...
                <button className="mt-6 sm:mt-8 bg-white/20 backdrop-blur-md px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold hover:bg-white/30 transition block">
                  <span className="bg-linear-to-r from-[#FFD900] via-[#FBFD89] to-[#FFD900] text-transparent bg-clip-text text-lg sm:text-xl">
                    Learn More →
                  </span>
                </button>
